  ...
  return (
    <div className="px-4 pb-4">
      ...
      <div className="card p-6 text-center mb-4">
        ...
        <p className="text-sm text-gray-500">{ROLE_LABELS.nurse}</p>
      </div>
      <div className="card p-4 space-y-3 text-sm">
        <div><span className="text-gray-500">Email:</span> {user?.email}</div>
        <div><span className="text-gray-500">Department:</span> {user?.department}</div>
        <div><span className="text-gray-500">Hospital:</span> {user?.hospital}</div>
        <div><span className="text-gray-500">License:</span> {user?.nurseLicense}</div>
      </div>
